            ...
            <Card className="p-0 overflow-hidden">
              <div className="relative aspect-video bg-black">
                      ...
                      {cameraError ? (
                        <>
                          ...
                          <div className="space-y-2">
                            <p className="text-xl font-bold text-white">Camera Error</p>
                            <p className="text-white/70 text-sm max-w-md mx-auto">{cameraError}</p>
                            <Button
                              onClick={startCamera}
                        ...
                        <>
                          ...
                          <p className="text-xl font-bold text-white">Initializing Camera...</p>
                        </>
                      ) : (
                        <>
                          ...
                          <div className="space-y-2">
                            <p className="text-2xl font-bold text-white">Camera Off</p>
                            <p className="text-white/70 text-sm max-w-md mx-auto">
                              Click "Start Camera" below to begin broadcasting
                            </p>
                          </div>
                        </>
                      )}
                ...
                <div className="absolute top-4 right-4 z-10">
                  <Badge className="bg-black/80 text-white backdrop-blur-sm px-4 py-2">
                    <Users className="w-4 h-4 mr-2" />
                    {analytics.currentViewers} watching
                  </Badge>
                </div>
              </div>
